...
function changecolor1(){
    var tiger=document.querySelectorAll(".changecolour10");
...
function changecolor2(){
   var lion= document.querySelectorAll(".changecolour10")
...
function changecolor3(){
    var leopard=document.querySelectorAll(".changecolour10")
...
function addTicket(){
    ...
    <main><textarea class="changecolour10" name="" id="" cols="30" rows="10">${boxcontent.value}</textarea></main>
</div>
`
title.value=``
boxcontent.value=``
